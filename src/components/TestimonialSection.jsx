...
export default function TestimonialSection() {
  const testimonials = [
    {
      quote:
        "Trouver une personne de confiance était un calvaire. Avec ADN PRO SERVICE, j'ai trouvé en 48h une perle rare.",
    ...
    {
      quote:
        "Service ultra réactif. Notre agent est ponctuel, discret et très professionnel. Je recommande vivement.",
      name: 'Jean-Pierre L.',
